...
This is the project for "Full Stack Web Developer Nanodegree" on Udacity. 

In this project, a Linux virtual machine needs to be configurated to support the Item Catalog website.

You can visit http://54.221.105.174 for the website deployed.
...
5. Clone the Catalog App to the virtual machine `git clone https://github.com/vuvu10/Item-Catalog.git`
